...
class collector_deviantart(collector):
    ...
    RE_IMAGEURL = re.compile('<meta name="og:image" content="(.+?\.(jpg|png|gif))">',re.DOTALL|re.IGNORECASE)

    # Regular expression to extract the maximum deviantionID from homepage
    RE_ALLDEVIATIONID = re.compile('href="http://www.deviantart.com/morelikethis/(\d+)"',re.DOTALL|re.IGNORECASE)
...
class collector_flickr(collector):
    ...
    RE_FLICKR_IMAGEURL = re.compile('src="(http://farm\d+.staticflickr.com.+?_t\.jpg)" width',re.DOTALL|re.IGNORECASE)
    RE_GOOGLEIMAGES_IMAGEURL = re.compile('imgurl=(http://.+?)&',re.DOTALL|re.IGNORECASE)
